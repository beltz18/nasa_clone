...
const infoS  = {
  fs: ['Webb Telescope', 'Solar System and Beyond', 'Artemis I'],
  ss: [
        "Artemis Teams Continue to Review Launch Options, Prepare to Replace Seal",
        "NASA's Webb Takes Its First-Ever Direct Image of Distant World",
        "Explore the Sola System With NASA's New-and-Improved 3D 'Eyes'",
        "Artemis I Travel Guide: The Essentials for Your Trip to the Moon"
      ]
}

module.exports = { title, arrUl1, arrUl2, arrUl3, infoS }